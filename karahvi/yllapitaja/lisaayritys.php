...
<div class="wrapper">
	...
	<form action="../inc/lisaayrity.php" method="post">           
		...
		<input type="password" name="salasana" class="form-control" placeholder="Salasana" required> <br>        
		<label>Toista Salasana</label>
		<input type="password" name="confirm_salasana" class="form-control" placeholder="Toista salasana" required>  <br>         
