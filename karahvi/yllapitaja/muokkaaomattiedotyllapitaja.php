...
<div class="container"> 
	<div class="col-xs-12 col-sm-12">
		<div class="panel panel-default">
			...
			<a href='omattiedotyllapitaja.php'>Takaisin omiin tietoihin</a>";
			...
			<div class="wrapper">
				...
				<p><input type="email" class="form-control" name="sahkopostiosoite" placeholder="Sähkopostiosoite" 
				...
				<button class="btn btn-default btn-sm"> <a href="omattiedotyllapitaja.php">PERUUTA</a></button></p>
				</form>
				<?php } ?>
			</div>
		</div>
