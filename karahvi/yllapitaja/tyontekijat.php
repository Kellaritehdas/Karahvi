...
<div class="container">   
	...
	<div class="col-xs-12 col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> Työntekijät </div>								
			<br>
			<div id="tulokset">
				<?php
				$kayttajaryhma_id = "2";
				...
				if ($tulokset->num_rows > 0) {
				   ...
				   ?> <p><button1 class="btn btn-primary btn-sm"><a href="muokkaatyontekijat.php?id=<?php echo $rivi["id"]; ?>">MUOKKAA</a></button1><br><br>
				   <button2 class="btn btn-default btn-sm"><a href="vaihdasstyontekijat.php?id=<?php echo $rivi["id"]; ?>">SALASANA</a></button2><br><br>
				   <button3 class='btn btn-danger btn-sm'><a href="poistatilityontekijat.php?id=<?php echo $rivi["id"]; ?>" onclick="return confirm('HALUATKO VARMASTI POISTAA TILIN KÄYTÖSTÄ?')">POISTA TILI</a></button3>
				   </p><?php 					
				   }
				} else {
				   echo "<br>";
