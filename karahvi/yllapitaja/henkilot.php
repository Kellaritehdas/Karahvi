...
<div class="container">   		
	...
	<div class="col-xs-12 col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> Henkilöasiakkaat </div>
			<br>
			...
			<div id="tulokset">
				...
				if ($tulokset->num_rows > 0) {
				   ...
				   ?> <p><button1 class="btn btn-primary btn-sm"><a href="muokkaahenkilot.php?id=<?php echo $rivi["id"]; ?>">MUOKKAA</a></button1><br><br>
				   <button2 class="btn btn-default btn-sm"><a href="vaihdasshenkilot.php?id=<?php echo $rivi["id"]; ?>">UUSI SALASANA</a></button2><br><br>
				   <button3 class='btn btn-danger btn-sm'><a href="poistatilihenkilot.php?id=<?php echo $rivi["id"]; ?>" onclick="return confirm('HALUATKO VARMASTI POISTAA TILIN KÄYTÖSTÄ?')">POISTA TILI</a></button3>
				   </p><?php 					
				   }
				} else {
				   echo "<br>";
