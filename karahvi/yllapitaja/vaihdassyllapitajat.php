...
<div class="container"> 
	<div class="panel panel-default">
		...
		<div class="wrapper">
			...
			<form action="../inc/suoritavaihssyllat.php" method="post"> 
				...
				<?php $vaihdettava = $_GET['id'];?>
				<input type="hidden" name="id" value="<?php echo $vaihdettava;?>">
				<br>
				<div class="form-group">
					<input type="submit" name="vaihdasana" class="btn btn-primary" value="Vaihda">
					<a class="btn btn-default" href="yllapitajat.php">Takaisin</a>
				</div>
			</form>
		</div>
	</div>
