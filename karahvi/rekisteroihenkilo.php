...
<div class="wrapper">
	...
	?>
        ...
        <form action="inc/rekisteroihenk.php" method="post">           
			...
			<input type="hidden" name="kayttajaryhma_id" class="form-control" value="3"><br>                			
			<label>Etunimi</label>
			...
			<input type="email" name="sahkopostiosoite" pattern="[a-zA-Z0-9@.-]+" class="form-control" placeholder="Sähköpostiosoite" required value="<?php if(isset($_GET['sahkopostiosoite'])){echo $_GET['sahkopostiosoite'];}?>"><br>
