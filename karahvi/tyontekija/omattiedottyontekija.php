				...
				<div id="tulokset">
					...
					if ($tulokset->num_rows > 0) {  
						while($rivi = $tulokset->fetch_assoc()) {      
							...
							?><p>
							<button1 class="btn btn-primary btn-sm"><a href="muokkaaomattiedottyontekija.php?id=<?php echo $rivi["id"]; ?>">MUOKKAA TIETOJA</a></button1><br><br> 
							<button2 class="btn btn-default btn-sm"><a href="vaihdasstyontekija.php?id=<?php echo $rivi["id"]; ?>">VAIHDA SALASANA</a></button2><br><br>  
							<button3 class='btn btn-danger btn-sm'><a href="poistatili.php?id=<?php echo $rivi["id"]; ?>" onclick="return confirm('HALUATKO VARMASTI POISTAA TILIN KÄYTÖSTÄ?')">POISTA TILI</a></button3>
							</p><?php 
