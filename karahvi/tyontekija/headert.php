...
if($_SESSION['kayttajaryhma_id'] != 2){
...
<html lang="en">
  <head>
    ...
    <title>KARAHVI / TYÖNTEKIJÄ</title>
	...
	<header>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="tyontekija.php">KARAHVI</a>
        </div>
		...
		?>   
		<form action="tuotteettyontekija.php" method="get">
		...
		<ul class="nav navbar-nav">      
		<li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown">Tilaukset
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="tilauksetavoimet.php">Avoimet tilaukset</a></li>
          <li><a href="tilauksettoimitettu.php">Toimitetut tilaukset</a></li>
          <li><a href="tilauksetperuttu.php">Perutut tilaukset</a></li>
        </ul>
		</li>
		</ul>
         <ul class="nav navbar-nav navbar-right">
			<li><a href="omattiedottyontekija.php" ><span class="glyphicon glyphicon-user"></span> Omat tiedot</a></li>
